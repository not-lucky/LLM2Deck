...
![Image: browser showing user login for notes](/static/8f7a272bf16d83b5507d0514de35e4a7/5a190/1new.png)
...
The user is not notified about a successful login in any way. Let's modify the application to show the login form only *if the user is not logged-in*, so when *user === null*. The form for adding new notes is shown only if the *user is logged-in*, so when *user* state contains the user's details.
...
We used the [label](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/label) element for the *input* fields in the login form. The *input* field for the username is placed inside the corresponding *label* element:
...
Why did we implement the form this way? Visually, the same result could be achieved with simpler code, without a separate *label* element:
...
The *label* element is used in forms to describe and name *input* fields. It provides a description for the input field, helping the user understand what information should be entered into each field. This description is programmatically linked to the corresponding input field, improving the form's accessibility.

This way, screen readers can read the field's name to the user when the input field is selected, and clicking on the label's text automatically focuses on the correct input field. Using the *label* element with *input* fields is always recommended, even if the same visual result could be achieved without it.
...
![Image: browser showing user data in console saved in local storage](/static/a69b93f2f1d403c968a3118a612a559a/5a190/3e.png)
...
![Image: browser showing visible login form only](/static/7974958a48f7a4e873550b1b85bd8cbd/5a190/4e.png)

If the user is logged-in, the name of the user and a list of blogs is shown.

![Image: browser showing blogs and who is logged in](/static/62a606d23ac2c2c96918567b8a8c7b32/5a190/5e.png)
...
![Image: browser showing logout button after logging in](/static/fa111e6eccf20340b5258c12553d2ea6/5a190/6e.png)
...
![Image: browser showing new blog form](/static/b9f4cf7f481e4f1358be610031afe219/5a190/7e.png)
...
![Image: browser showing successful operation notification](/static/58838a80180d9d94fb4bc3673a8a67c0/5a190/8e.png)

Failed login can show the following notification:

![Image: browser showing failed login attempt notification](/static/5f30f6f454735133b39d706a3fa7f9c1/5a190/9e.png)
