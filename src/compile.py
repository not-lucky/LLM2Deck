...
def compile_deck(
    ...
    basic_model_id = generate_id("LLM2Deck Basic Model")
    cloze_model_id = generate_id("LLM2Deck Cloze Model")
    mcq_model_id = generate_id("LLM2Deck MCQ Model")
    ...
    # Create Deck using the generated deterministic deck ID
