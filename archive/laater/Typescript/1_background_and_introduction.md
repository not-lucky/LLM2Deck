...
![Diagram illustrating the three parts of TypeScript — The Language, The Compiler, and The Language Service — and their relationships. The Language consists of syntax, keywords, and type annotations. The Compiler handles type information erasure and code transformations (transpiling TypeScript to JavaScript). The Language Service collects type information from source code to power IDE features like intellisense, type hints, and refactoring.](https://courses.mooc.fi/api/v0/files/course/727b37dd-1ad7-4ffa-971c-d45671eef876/images/Nlr5QHLCzJIMzI4FEKAN24nPdVE7pJ.png)
...
>
> Click the button below to mark this chapter as completed. Once locked, you'll be able to access additional content.
>
> *[Lock Chapter]*
